...
type IconName =
  | 'compass' | 'menu' | 'alert' | 'globe' | 'chevron'
  | 'mail' | 'phone' | 'pin' | 'building' | 'users' | 'briefcase'
  | 'megaphone' | 'newspaper' | 'document' | 'folder' | 'wallet'
  | 'gavel' | 'project' | 'calendar' | 'arrow-right' | 'home'
  | 'search' | 'login' | 'logout' | 'plus' | 'edit' | 'trash' | 'close';
...
export default function Icon({ name, size = 18, ...rest }: Props) {
  ...
  switch (name) {
    ...
    case 'building': return <svg {...common}><rect x="4" y="2" width="16" height="20" rx="2"/><path d="M9 22v-4h6v4"/><path d="M8 6h.01M16 6h.01M12 6h.01M12 10h.01M12 14h.01M16 10h.01M16 14h.01M8 10h.01M8 14h.01"/></svg>;
    ...
    case 'megaphone': return <svg {...common}><path d="M3 11v3a1 1 0 0 0 1 1h3l5 4V6L7 10H4a1 1 0 0 0-1 1z"/><path d="M16 8a5 5 0 0 1 0 8"/></svg>;
    case 'newspaper': return <svg {...common}><path d="M4 22h16a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H8a2 2 0 0 0-2 2v16a2 2 0 0 1-4 0V11h4"/><path d="M18 14h-8M15 18h-5M10 6h8v4h-8z"/></svg>;
    case 'document': return <svg {...common}><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="9" y1="13" x2="15" y2="13"/><line x1="9" y1="17" x2="15" y2="17"/></svg>;
    case 'folder': return <svg {...common}><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"/></svg>;
    case 'wallet': return <svg {...common}><path d="M20 12V8H6a2 2 0 0 1-2-2c0-1.1.9-2 2-2h12v4"/><path d="M4 6v12c0 1.1.9 2 2 2h14v-4"/><path d="M18 12a2 2 0 0 0 0 4h4v-4z"/></svg>;
    case 'gavel': return <svg {...common}><path d="m14.5 9.5-5 5"/><path d="m18 4-7 7"/><path d="m13 2 9 9-3 3-9-9z"/><path d="M3 21h12"/><path d="m5 17 4 4"/></svg>;
    case 'project': return <svg {...common}><polygon points="12 2 22 8.5 22 15.5 12 22 2 15.5 2 8.5 12 2"/><line x1="12" y1="22" x2="12" y2="15.5"/><polyline points="22 8.5 12 15.5 2 8.5"/></svg>;
    ...
    case 'login': return <svg {...common}><path d="M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4"/><polyline points="10 17 15 12 10 7"/><line x1="15" y1="12" x2="3" y2="12"/></svg>;
